...
class IdmProfileSetV2DistinctNewLoginUserMorePropsCase(TestCase):
    ...
    def __init__(self, build_user, identification):
        ...
        self.import_file_name = "IdmProfileSetV2DistinctNewLoginUserMorePropsCase_{}_{}_importer.json".format(build_user, identification)
        self.cost = 0
    ...
    def do_test(self, servers, count, list_count, proportion=0):
        ...
        print("开始导入 profile_set(登录新用户 125 个属性 version=2.0) 数据, 数据量={}".format(1200000))
        ...
        print("导入 profile_set(登录新用户 125 个属性 version=2.0) 数据完成")
