...
class IdmTrackProfileV3MixedUserCase(TestCase):
    ...
    def run_make_records(self, servers, count, list_count, already_identities, concurrent_index):
        ...
        print("导入 新老用户 profile + track 混合数据(version=3.0) 数据, 并发序号={}, 导入量={}, cost={}ms"
    ...
    def make_track_profile_mixed_user(self, already_identities, concurrent_index, count):
        ...
        while num <= count:
            ...
            if num % 20 == 0:
                ...
                birthdays = ['2001-01-01', '1999-09-09', '1998-08-08', '1997-07-07', '1996-06-06', '1995-05-05',
                             '1994-04-04', '1993-03-03', '1992-02-02', '1991-01-01']
                if profile_count % 50 == 0:
                    distinct_id = str(uuid.uuid4()) + str(int(current_time * 1000000)) + '_' + str(random_num) + str(
                        concurrent_index)
                    login_id = 'user_' + str(int(current_time * 1000000)) + '_' + str(random_num) + str(
                        concurrent_index)
                    idfv = 'idfv_' + str(int(current_time * 1000000)) + '_' + str(random_num) + str(concurrent_index)
                    mobile = 'mobile_' + str(int(current_time * 1000000)) + '_' + str(random_num) + str(
                        concurrent_index)
                    ...
                    taobao = 'taobao_' + str(int(current_time * 1000000)) + '_' + str(random_num) + str(
                        concurrent_index)
                else:
                ...
                if track_count % 50 == 0:
                    distinct_id = str(int(current_time * 1000000)) + '_' + str(random_num) + str(concurrent_index)
                    login_id = 'user_' + str(int(current_time * 1000000)) + '_' + str(random_num) + str(
                        concurrent_index)
                    idfv = 'idfv_' + str(int(current_time * 1000000)) + '_' + str(random_num) + str(concurrent_index)
                    mobile = 'mobile_' + str(int(current_time * 1000000)) + '_' + str(random_num) + str(
