...
class IdmProfileSetV2DistinctNewAnonymousUserCase(TestCase):
    ...
    def __init__(self, idm_engine_type):
        ...
        self.basic_data_path = f"hdfs:///sa/runtime/daily_benchmark_basic_data/{idm_engine_type}/id2/anonymous_new_profile_set"
    ...
    def do_test(self, basic_data_ip, target_ips, project, count):
        ...
        start_spark_job(basic_data_ip, self.work_path, self.script_path,
                        "IdmProfileSetV2DistinctNewAnonymousUserCase", 'id2',
