...
class IdmProfileSetV2DistinctOldLoginUserCase(TestCase):
    ...
    def __init__(self, build_user, identification):
        ...
        self.input_file_dir = "profile_set_v2_login_user_{}_{}".format(build_user, identification)
    ...
    def do_test(self, exec_ip, ips, project, count):
        ...
        start_spark_job(exec_ip, self.work_path, self.script_path, "IdmProfileSetV2DistinctOldLoginUserCase", 'id2',
